...
public class TimeTaskConfig implements SchedulingConfigurer {
    ...
    public void configureTasks(ScheduledTaskRegistrar taskRegistrar) {
        ...
        for (SpringScheduledCron springScheduledCron : springScheduledCrons) {
            ...
            if(true){
                ...
                //类版本
                taskRegistrar.addTriggerTask((baseTimeTask),new MyTrigger(springScheduledCron,baseTimeTask));
            }
        }
    }
    ...
    private class MyTrigger implements Trigger {
        public SpringScheduledCron springScheduledCron;
        public BaseTimeTask baseTimeTask;

        public MyTrigger(SpringScheduledCron springScheduledCron, BaseTimeTask baseTimeTask) {
            this.springScheduledCron = springScheduledCron;
            this.baseTimeTask = baseTimeTask;
        }
